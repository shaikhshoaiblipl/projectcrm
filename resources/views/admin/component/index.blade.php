...
<div class="container">
    ...
    <div class="card">
        <div class="card-header py-3 cstm_hdr">
            ...
            <a href="{{ route('admin.components.create') }}" class="btn btn-sm btn-icon-split float-right btn-outline-warning">
        ...
        <div class="card-body">       
          <div class="table-responsive">
                <table class="table table-bordered" width="100%" cellspacing="0" id="components">
                    <thead>
                        <tr>                            
                            <th>Name</th>
                            <th>Status</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                             <a href="{{route('admin.components.edit',[$component->id])}}" class="btn btn-success btn-circle btn-sm" title="edit"><i class="fas fa-edit"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
