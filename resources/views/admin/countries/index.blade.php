...
<div class="container">
  <div class="breadcrumb-header justify-content-between">
      <div class="left-content">
          <div>
            <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Countries</h2>
          </div>
      </div>
  </div>
    ...
    <div class="col-xl-12">
      <div class="card">
        <div class="card-header py-3 cstm_hdr">
            ...
            <a href="{{route('admin.countries.create')}}" class="btn btn-sm btn-icon-split float-right btn-outline-warning">
