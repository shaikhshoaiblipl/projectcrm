    ...
    <div class="col-xl-12">
      <div class="card">
        <div class="card-header py-3 cstm_hdr">
            ...
            <a href="{{route('admin.projecttype.create')}}" class="btn btn-sm btn-icon-split float-right btn-outline-warning">
                <span class="icon text-white-50">
                  <i class="fas fa-plus"></i>
                </span>
                <span class="text">Add Project Type</span>
            </a>
...
<script type="text/javascript">   
    ...
    function getCategories(){
        ...
        jQuery('#categories').DataTable({
            ...
            iDisplayLength:50,
            ajax: {
                url: "{{ route('admin.projecttype.getProjectTypes') }}",
                method: 'POST',
                data: {
                }
            },
